...
run_root = Path("/Users/dagfev/Documents/SWMFsoftware/BATSRUS/run_earlyearth")
...
pattern = run_root / "GM/IO2/y=0_var_1_n*.dat"
...
for file in files_sorted:
    ...
    noclobber_file = run_root / f"planet_{i:08d}_processed.txt"
