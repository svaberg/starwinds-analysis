...
- DONE (partial): core shell profile workflows and explicit-surface shell wrappers now
  read shell values directly from the shell `SmartDs` (`shell_ds("...")`) instead of
