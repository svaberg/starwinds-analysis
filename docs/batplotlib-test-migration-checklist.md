...
into
`/Users/dagfev/Documents/starwinds/batwind/test`.
...
- Warning source: `batwind/physics/orbit_surface.py` runtime warnings in the tested path.
...
| `test_numpy_save.py` | `test/test_batwind_pipe.py`, `test/test_batwind_pipe_results.py` | Migrated | Recorder-backed JSON persistence + inspector tooling tested |
