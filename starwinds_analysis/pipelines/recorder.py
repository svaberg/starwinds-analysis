...
class ScientificFloatEncoder(json.JSONEncoder):
    ...
    Used by: `starwinds_analysis/pipelines/recorder.py`
    """
...
def safe_name(text: str) -> str:
    ...
    Used by: `starwinds_analysis/pipelines/recorder.py`, `starwinds_analysis/pipelines/sw_pipe.py`
    """
...
def state_file_path(directory: str | Path, *, pipeline_name: str) -> Path:
    ...
    return Path(directory) / f"sw-pipe.{safe_name(pipeline_name)}.processed.json"
...
class SwRecordHandler(logging.Handler):
    """
