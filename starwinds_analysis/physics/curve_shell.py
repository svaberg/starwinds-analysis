"""THIS FILE contains curve-vs-shell comparison workflows.

It compares values estimated along a sampled curve against shell-integrated
reference values at the same radius. This is workflow-heavy physics code.
"""
