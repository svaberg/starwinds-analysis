...
def test_read_dataset(file='sample_data/3d__var_1_n00000000.plt'):
...
def test_rename_variable(file='sample_data/3d__var_1_n00000000.plt'):
    grid = basic_read(file)
    grid.rename_array('te [K]', 'te (K)')


def test_create_new_variable(file='sample_data/3d__var_1_n00000000.plt'):
    grid = basic_read(file)
    grid.point_data['fdfds te [K]'] = 40 * grid.point_data['te [K]']


def test_set_vector(file='sample_data/3d__var_1_n00000000.plt'):
    grid = basic_read(file)
...
def test_scalar_vector_read(file='sample_data/3d__var_1_n00000000.plt'):
