...
@pytest.mark.interactive
def test_density_volumetric(file='examples/3d__var_1_n00000000.plt'):
...
@pytest.mark.interactive
def test_plot_over_line(file='examples/3d__var_1_n00000000.plt'):
    grid = reader.read(file)
...
# def test_sample_over_line(file='examples/3d__var_3_n00060000.plt'):
#     grid = reader.read(file)
