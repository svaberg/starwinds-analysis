...
def test_slice(file='sample_data/3d__var_1_n00000000.plt'):
...
@pytest.mark.interactive
def test_isosurface(file='sample_data/3d__var_1_n00000000.plt'):
...
@pytest.mark.interactive
def test_alfven_surface(file='sample_data/3d__var_1_n00000000.plt'):
