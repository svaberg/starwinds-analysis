...
def test_pressure_components_on_surface_skips_relative_when_no_trajectory_velocity():
    ...
    sampled.merge_computation_graph(build_batsrus_graph(sampled.raw.variables, gamma=sampled.raw.aux.get("GAMMA"), body_radius_m=SOLAR_RADIUS_M))
    sampled.merge_computation_graph(build_spherical_graph(tuple(sampled)))
